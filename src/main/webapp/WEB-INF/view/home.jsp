			...
			<div class="card mb-3">
				...
				<div class="card-body">
					<div class="gap-2 d-md-flex">
						...
						<button id="item_add" class="btn btn-primary mt-2" type="submit"
							formaction="./add">商品追加</button>
					</div>
				</div>
			</div>
			<div class="card mb-3" id="item_info">
				...
				<div class="card-body">
					<div class="gap-2 d-md-flex">
						...
						<button id="item_edit" class="btn btn-primary mt-2" type="submit"
							formaction="./edit">商品編集</button>
					</div>
