 ...
 * 作成者  ：FLM Uzawa
 *------------------------------------------------------------------------------
 * 修正履歴 (修正日：8/18 担当者：kenseiarai 修正内容)
 *------------------------------------------------------------------------------
 */
...
public class ItemDao {
	...
	public Item select(int shopId, int itemId) throws SQLException {
		...
		String sql = "SELECT shop_id, item_id, item_name, item_describe, item_price, item_reg FROM item"
	...
	public int insert(Item item) throws SQLException {
		...
		String sql = "INSERT INTO item(shop_id, item_id, item_name, item_describe, item_price, item_reg)"
				+ " VALUES(?, ?, ?, ?, ?, ?)";
	...
	public void update(Item item) throws SQLException {
		...
		String sql = "UPDATE item set item_name = ?, item_describe = ?, item_price = ? ,item_reg = ?"
				+ " WHERE shop_id = ? AND item_id = ?";
